...
# naiyun Naiyun Airport Official Address (Updated June 29, 2026)
...
Latest Official Website Address 01: [www.naiun.me](https://www.v2ny.de/#/register?code=QPB5cCmr)</br>
Latest Official Website Address 02: [v13.v2ny.me](https://v13.v2ny.me/?path=register&code=KacwlzHN)</br>
...
“Naiyun” is a professional network link optimization service. It supports 58 global access points and provides [US residential broadband](https://github.com/jdnei/naiyun#1%E7%BE%8E%E5%9B%BD), [Hong Kong residential broadband](https://github.com/jdnei/naiyun#2%E9%A6%99%E6%B8%AF), [Taiwan residential broadband](https://github.com/jdnei/naiyun#3%E5%8F%B0%E6%B9%BE), [Japan residential broadband](https://github.com/jdnei/naiyun#4%E6%97%A5%E6%9C%AC), [Korea residential broadband](https://github.com/jdnei/naiyun#5%E9%9F%A9%E5%9B%BD), and Malaysia residential broadband. It aims to provide stable network acceleration support for cross-border office work, overseas academic research, and audio/video enthusiasts.

## Naiyun Airport Invitation Code:

```bash
QPB5cCmr
```

Register with this invitation code now to enjoy a free 3-day unlimited-traffic trial service.

## New users with an invitation code can place orders using the discount code

```bash
NYNY
```

After the free trial ends, new users can use a one-time discount code for their first annual order. The original price is ~~¥168/year~~, and the discounted price is XX yuan/year, allowing users to purchase one year of service at a discounted price.
![image](https://github.com/jdnei/naiyun/blob/main/img/QQ20260622-094015.jpg?raw=true)

## Plans

| Plan Name                          | Price   | Billing Method | Monthly Traffic / Total Traffic | Validity      | Supported Devices | Speed Limit | Dedicated Line Network | Streaming Unlock | Data Center Cabinet | Account Sharing | Notes                                                                                     |
| ---------------------------------- | ------- | -------------- | ------------------------------- | ------------- | ----------------- | ----------- | ---------------------- | ---------------- | ------------------- | --------------- | ----------------------------------------------------------------------------------------- |
| Basic - Basic Plan (Special Offer) | ¥128.00 | Yearly         | 168G                            | Yearly        | 5 devices         | 5000M       | Available              | Supported        | Yes                 | Not allowed     | Automatically resets on the order date                                                    |
| Pro - Advanced Plan                | ¥28.00  | Monthly        | 388G                            | Monthly       | 5 devices         | 5000M       | Available              | Supported        | Yes                 | Not allowed     | Automatically resets on the order date                                                    |
| Max - Professional Plan            | ¥49.00  | Monthly        | 788G                            | Monthly       | 5 devices         | 5000M       | Available              | Supported        | Yes                 | Not allowed     | Automatically resets on the order date                                                    |
| 280G [Pay-As-You-Go]               | ¥98.00  | One-time       | 280G                            | No time limit | 5 devices         | 5000M       | Available              | Supported        | Yes                 | Not allowed     | Valid until the traffic is used up; multiple purchases cannot be stacked                  |
| 680G [Pay-As-You-Go]               | ¥218.00 | One-time       | 680G                            | No time limit | 5 devices         | 5000M       | Available              | Supported        | Yes                 | Not allowed     | Valid until the traffic is used up; multiple purchases cannot be stacked                  |
| 2048G [Pay-As-You-Go]              | ¥498.00 | One-time       | 2048G                           | No time limit | 5 devices         | 5000M       | Available              | Supported        | Yes                 | Not allowed     | Valid until the traffic is used up; multiple purchases cannot be stacked; almost sold out |

## Advantages

Global coverage: Deploys 149 global POP access points, covering Southeast Asia, Europe, the United States, and some rare regions.</br>
Enterprise-grade links: Uses Global Accelerator international dedicated-line technology, with high-availability SLA protection across all nodes.</br>
Ultra-HD support: Optimized transmission efficiency for mainstream 4K/8K video streaming, with extremely low latency.</br>
...
| AE        | 🇦🇪 ARE·United Arab Emirates 01 ³ˣ                        | TROJAN   | x3.0       | Online            | 56%  |
| Ungrouped | 🇨🇳If a node fails, please try updating the subscription  | VMESS    | x3.0       | Under Maintenance | —    |
| Ungrouped | 🇨🇳Permanent Address: [WWW.V2NY.COM](http://WWW.V2NY.COM) | VMESS    | x3.0       | Under Maintenance | —    |
| Ungrouped | 🇨🇳Mainland Access: v13.v2ny.me                           | VMESS    | x3.0       | Under Maintenance | —    |
| Ungrouped | 🇨🇳[Official]👇Telegram Group👇                           | VMESS    | x3.0       | Under Maintenance | —    |
| Ungrouped | 🇨🇳Welcome to join 👉@V2NAIUN👈                           | VMESS    | x3.0       | Under Maintenance | —    |
